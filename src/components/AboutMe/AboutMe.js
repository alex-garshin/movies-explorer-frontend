      ...
      <div className="about-me__container">
        <div className="about-me__text-wrapper">
          ...
          <p className="about-me__description">
            ...
            Государственном Техническом Университете. Я люблю слушать музыку, а
            ещё увлекаюсь бегом. Недавно начал кодить. С 2022 года работаю в
        ...
        <div className="about-me__photo-container"><img className="about-me__photo" src={photo} alt="Фото студента" /></div>
      </div>
    </section>
  );
};
