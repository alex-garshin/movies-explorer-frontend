          ...
          <nav className="navigation__panel">
            ...
            <ul className="navigation__list">
              <li className="navigation__list-item">
                <Link
                  className={`link navigation__link ${
                    location.pathname === navigateLinks.home
              ...
              <li className="navigation__list-item">
                <Link
                  className={`link navigation__link ${
                    location.pathname === navigateLinks.films
                      ? "navigation__link_active"
                      : ""
                  }`}
              ...
              <li className="navigation__list-item">
                <Link
                  className={`link navigation__link ${
                    location.pathname === navigateLinks.savedFilms
                      ? "navigation__link_active"
                      : ""
                  }`}
            ...
            <button
              ...
              onClick={() => navigate(navigateLinks.profile)}
            >
